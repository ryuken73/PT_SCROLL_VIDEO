...
class ScrollyVideo {
  constructor({
    ...
    this.updateScrollPercentage = (jump) => {
      ...
      console.log(containerBoundingClientRect.left, containerBoundingClientRect.width, window.innerWidth)
      console.log(containerBoundingClientRect.top, containerBoundingClientRect.height, window.innerHeight)
      // const scrollPercentY = (-containerBoundingClientRect.top)
      //   / (containerBoundingClientRect.height - window.innerHeight);
      const scrollPercent = (-containerBoundingClientRect.left)
        / (containerBoundingClientRect.width - window.innerWidth);
    ...
    if (this.trackScroll) {
      // eslint-disable-next-line no-undef
      console.log('trackSCroll:', this.trackScroll)
      // window.addEventListener('scroll', this.updateScrollPercentage);
      window.addEventListener('scroll', throttleUsingRaf(this.updateScrollPercentage));
